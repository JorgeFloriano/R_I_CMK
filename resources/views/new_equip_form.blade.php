            ...
            <div class="col-lg-6 offset-lg-3">
                ...
                <form action="{{route('new_equip_submit')}}" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" step="1" class="form-control" placeholder="Ex.: 1.1" aria-label="Ex.: 1.1" aria-describedby="lblDirAlta" id="idDirAlta" name="txtDirAlta">
                    </div>

                    <div class="input-group mb-3">
                        <label for="idDirBaixa" class="input-group-text" id="lblDirBaixa">Corr. direção vel. baixa (A):</label>
                        <input type="number" step="1" class="form-control" placeholder="Ex.: 0.8" aria-label="Ex.: 0.8" aria-describedby="lblDirBaixa" id="idDirBaixa" name="txtDirBaixa">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" step="1" class="form-control" placeholder="Ex.: 2.8" aria-label="Ex.: 2.8" aria-describedby="lblElevAlta" id="idElevAlta" name="txtElevAlta">
                    </div>

                    <div class="input-group mb-3">
                        <label for="idElevBaixa" class="input-group-text" id="lblElevBaixa">Corr. Elevação vel. baixa (A):</label>
                        <input type="number" step="1" class="form-control" placeholder="Ex.: 1.8" aria-label="Ex.: 1.8" aria-describedby="lblElevBaixa" id="idElevBaixa" name="txtElevBaixa">
                    </div>
