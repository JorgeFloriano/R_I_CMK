<table style="margin-bottom: 100px;">
    ...
    <tr><td>Data: {{date('d/m/Y',strtotime($r['d_tec1']))}}</td><td>Data: {{date('d/m/Y',strtotime($r['d_tec2']))}}</td></tr>
    <tr><td>Início: {{date('H:i', strtotime($r['h_i_tec1']))}} h / Final: {{date('H:i', strtotime($r['h_f_tec1']))}} h</td><td>Início: {{date('H:i', strtotime($r['h_i_tec2']))}} h / Final: {{date('H:i', strtotime($r['h_f_tec2']))}} h</td></tr>
</table>